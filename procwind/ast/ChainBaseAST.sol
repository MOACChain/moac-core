 ...
 * @author David Chen
 * @dev 
 * AppChain definition with Atomic Swap of Token(AST).
 * SCS need to use this contract to form the AppChain.
 * 
...
contract ChainBaseAST {
    ...
    //constructor
    function ChainBaseAST(address proto, address vnodeProtocolBaseAddr, address ercAddr,  uint ercRate, uint min, uint max, uint thousandth, uint flushRound) public {
