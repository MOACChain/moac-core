/*
 * Example shows how to deposit ERC20 token to the AppChain and withdraw native token from the AppChain.
 * 
 * Require:
 ...
 * 6. The ERC20 contract address on the BaseChain;
...
var fs = require('fs');
var solc = require('solc');//only 0.4.24 or 0.4.26 version should be used, npm install solc@0.4.24
...
var SCSVia="";//SCSVia is in the userconfig.json, as VNODE proxy

//For AST, this value should be the same as the TokenSupply when deploying
...
// Deposit ERC20 token to the AppChain
