...
/**
 * @title RandDropChainBaseAST.sol
 * @author David Chen
 *         Yifan Wang
 *         Qing Xu
 * MicroChain definition with Atomic Swap of Token(AST).
 * SCS need to use this contract to form the RandDrop AppChain.
 * Notice: 
 *  this file should be compiled with solidity 0.4.21 with optimize
 *  to limit the size of Code
 *
...
//ERC20 Contract used to exchange
contract TestCoin {
...
contract SubChainBase {
    ...
    //constructor
    function SubChainBase(address proto, address vnodeProtocolBaseAddr, address ercAddr,  uint ercRate, uint min, uint max, uint thousandth, uint flushRound, address vssbaseAddr) public {
