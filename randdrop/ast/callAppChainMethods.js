...
for(var i = 0; i < mclist.length; i++){
      ...
      console.log("AppChain token balance:", chain3.scs.getAppChainInfo(mclist[i]).balance);
...
var mcabi = ABIs.randdropAsm;//load in the AppChain ABI from external file

// Create the AppChain Object with abi
var mcObject = chain3.appchain(JSON.parse(mcabi));
...
console.log("AppChain dappList:", dappBase.getDappList());
console.log("dappBase nodeList:", dappBase.getCurNodeList());

//Dapp on AppChain can also be called by setup the object with 
return;
