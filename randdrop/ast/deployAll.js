...
var tokensupply = "";//should be the same as ERC20 totalsupply
...
// need to set to 1
var appchainContract = chain3.mc.contract(JSON.parse(ABIs.randdropAst));
var appChain;
...
}, (error) => {  console.log("deploy RandDropChainBaseAST error:" + error);});
